...
/*
 * Privacy: round coordinates to a ~1 km grid (2 decimal places).
 * Good enough for "0.8 mi away", useless for finding a front door.
 * We NEVER store exact device coordinates (spec §3.3).
 */
